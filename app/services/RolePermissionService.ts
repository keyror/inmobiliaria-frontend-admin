...
class RolePermissionService {
  ...
  async updateRole(id: number | null, payload: any): Promise<any> {
    return useApi(`${ApiUrls.ROLES_UPDATE_PUT}/${id}`, {
      method: "PUT",
      body: payload,
    });
  }
  ...
  async createPermission(payload: any): Promise<any> {
    return useApi(ApiUrls.PERMISSIONS_CREATE_POST, {
      method: "POST",
      body: payload,
    });
  }
  ...
  async updatePermission(id: number | null, payload: any): Promise<any> {
    return useApi(`${ApiUrls.PERMISSIONS_UPDATE_PUT}/${id}`, {
      method: "PUT",
      body: payload,
    });
  }
  ...
  async deletePermission(id: number | string): Promise<any> {
    return useApi(`${ApiUrls.PERMISSIONS_DELETE_DELETE}/${id}`, {
      method: "DELETE",
    });
  }
