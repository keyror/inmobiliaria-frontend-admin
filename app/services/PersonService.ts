...
class PersonService {
  ...
  async createPerson(payload: any): Promise<any> {
    return useApi(ApiUrls.PEOPLE_CREATE_POST, {
      method: "POST",
      body: payload,
    });
  }
  ...
  async updatePerson(id: string | number, payload: any): Promise<any> {
    return useApi(`${ApiUrls.PEOPLE_UPDATE_PUT}/${id}`, {
      method: "PUT",
      body: payload,
    });
  }
  ...
  async deletePerson(id: string | number): Promise<any> {
    return useApi(`${ApiUrls.PEOPLE_DELETE_DELETE}/${id}`, {
      method: "DELETE",
    });
  }
  ...
  async createFiscalProfile(payload: any): Promise<any> {
    return useApi(ApiUrls.FISCAL_PROFILES_CREATE_POST, {
      method: "POST",
      body: payload,
    });
  }
  ...
  async updateFiscalProfile(id: string | number, payload: any): Promise<any> {
    return useApi(`${ApiUrls.FISCAL_PROFILES_UPDATE_PUT}/${id}`, {
      method: "PUT",
      body: payload,
    });
  }
  ...
  async deleteFiscalProfile(id: string | number): Promise<any> {
    return useApi(`${ApiUrls.FISCAL_PROFILES_DELETE_DELETE}/${id}`, {
      method: "DELETE",
    });
  }
}
