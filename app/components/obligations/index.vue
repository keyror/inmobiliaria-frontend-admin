        ...
        <form class="row gx-3">
          ...
          <div class="col-md-4 col-sm-6">
            ...
            <VueDatePicker
              ...
              :class="{
                'is-invalid': getFieldError(index, 'expiration_date'),
              }"
              :state="getFieldError(index, 'expiration_date') ? false : null"
            />

            <small class="text-danger">
              {{ getFieldError(index, "expiration_date") }}
            </small>
          </div>
...
const { validate, values, resetForm, errors, setErrors } = useObligationForm();

const { remove, push, fields } =
  useFieldArray<IPropertyObligation>("obligations");
