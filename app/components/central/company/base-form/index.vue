...
import CentralCompanyGeneral from "~/components/central/company/general/index.vue";
import CentralCompanySettings from "~/components/central/company/settings/index.vue";
import Contacts from "~/components/contacts/index.vue";
import PublishChannels from "~/components/publish-channels/index.vue";
import { useApiHandler } from "~/composables/useApiHandler";
import { Constants } from "~/constants/Constants";
import AlertService from "~/services/AlertService";
import CompanyService from "~/services/central/CompanyService";
...
const companyRef = ref<InstanceType<typeof CentralCompanyGeneral> | null>(null);
...
const settingsRef = ref<InstanceType<typeof CentralCompanySettings> | null>(null);
