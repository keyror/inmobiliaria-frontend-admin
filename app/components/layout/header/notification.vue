<template>
  <li class="onhover-dropdown notification-box">
    <a href="javascript:void(0)">
      <Icon name="material-symbols:notifications-outline" size="20" />
            ...
            <div class="media-body">
              ...
              <ul class="user-group">
                ...
                <li class="reply" v-if="item.reply">
                  <nuxt-link to="javascript:void(0)"> Reply </nuxt-link>
                </li>
              </ul>
            </div>
          </div>
...
const alldata = ref<Notification[]>([]);
const { data } = await useFetch<HeaderResponse>(baseUrl + "/admin/data/header.json");
watchEffect(() => {
  if (data.value) {
