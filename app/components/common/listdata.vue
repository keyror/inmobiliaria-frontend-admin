  ...
  >
    <div class="property-box">
      <div class="property-image">
        ...
        >
          <swiper-slide v-for="(img, index) in item.img" :key="index">
            <a
              ...
              class="bg-size background_wrapper"
        ...
        <div class="labels-left">
          <div>
            <span
              :class="
                item.label[0] == 'no fees' ? 'label-dark' : 'label-shadow'
              "
              class="label"
              >{{ item.label[0] }}</span
            >
          </div>
          <span v-if="item.label[1]" class="label label-success">{{
            item.label[1]
          }}</span>
        </div>
        <div class="seen-data">
      ...
      <div class="property-details">
        ...
        <nuxt-link
          to="https://sheltos-vue.vercel.app/property/single-property-8"
        >
          <h3>{{ item.title }}</h3>
        </nuxt-link>
        <h6>${{ item.price }}*</h6>
