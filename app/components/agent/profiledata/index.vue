              ...
              <div class="card">
                <div class="card-body">
                    ...
                    <div class="media-body">
                      ...
                      <span class="light-font"
                        ...
                        <a href="javascript:void(0)"
                          >Mina Road, Dubai, United Arab Emirates</a
                        ></span
                      >
                  ...
                  <div class="contact-btn">
                    <button
                      type="button"
                      onclick="document.location='/users/allusers'"
                    ...
                    <button
                      type="button"
                      onclick="document.location='/users/adduser'"
                      class="btn btn-dashed color-4 ms-2 btn-pill"
                    >
                      Message
                    </button>
                  </div>
              ...
              <div class="follow-list">
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul>
                      <li
                        v-for="(item, index) in inputsData.following"
                        :key="index"
                      >
                        <div class="media">
                          <img
...
const { data } = await useFetch<AgentJson>(baseUrl + "/data/agent.json");
const { data: follow } = await useFetch<UserJson>(baseUrl + "/data/user.json");
watchEffect(() => {
