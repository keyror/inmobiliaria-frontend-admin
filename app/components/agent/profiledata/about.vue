            ...
            <div class="partner-info">
              ...
              <div class="time-details agent-time-details">
                <div>
                  <ul>
                    <li
                      v-for="(item, index) in inputsData.meetings"
                      :key="index"
                    >
            ...
            <div class="friend-list">
              <ul class="row">
                <li
                  ...
                  v-for="(item, index) in inputsData.friends"
                  :key="index"
                >
...
const inputsData = ref<UserData>({
  meetings: [],
  friends: [],
});
const { data } = await useFetch<UserData>(baseUrl + "/data/user.json");
watchEffect(() => {
  if (data.value) {
    inputsData.value = {
      meetings: data.value.meetings || [],
